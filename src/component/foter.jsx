      ...
      <div className="footer-section">
        <div className="company-info">
          ...
          <div className="social-icons">
            ...
            <Link to="https://g.co/kgs/VLGA3kP" className="iconn"><i className="fab fa-google"></i></Link>
            <Link to="https://www.linkedin.com/company/a-s-international-hr-consultancy" className="iconn"><i className="fab fa-linkedin"></i></Link>
          </div>
        </div>
